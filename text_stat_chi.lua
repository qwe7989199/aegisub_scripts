...
function show_result()
	...
	{x=0, y=2, class="label", label="　　总音节数: "..TotalKNum},
	{x=0, y=3, class="label", label="　　总字数(含空格): "..TotalWordsNum},
	{x=0, y=4, class="label", label="　　英文字数: "..EngWordsNum},
	{x=0, y=5, class="label", label="　　非英文字数: "..NonEngCharsNum},
	{x=0, y=6, class="label", label="　　半角空格数: "..SpaceNum-fullWidthSpaceNum},
	{x=0, y=7, class="label", label="　　全角空格数: "..fullWidthSpaceNum},
	...
	if btn=="Save" then
		...
		file_name=aegisub.dialog.save("保存文件到",aegisub.decode_path("?script").."\\", scriptname.."_stats", "*.txt")
		...
		.."　　时间最长的行: "..MaxLineDuration.." (秒) | 行号: "..MaxDurationIndex.."\n"
		.."　　时间最短的行: "..MinLineDuration.." (秒) | 行号: "..MinDurationIndex.."\n"
		.."　　时间最长的音节: "..max_k.dur.." (毫秒)   | 行号: "..max_k.line_index.."\n"
		.."　　时间最短的音节: "..min_k.dur.." (毫秒)   | 行号: "..min_k.line_index.."\n"
		)
		file:close()
	end
end
