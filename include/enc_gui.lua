...
{	
	...
	{x=7,y=4,width=3,class="edit",name="vsfm",value=vsfmpath or "",hint='must be 64bit version'},
	{x=0,y=5,class="label",label="vsfilter.dll:"},
	{x=1,y=5,width=5,class="edit",name="vsf",value=vsfpath or "",hint='must be 64bit version'},
