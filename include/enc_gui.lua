...
{	
	...
	{x=6,y=2,class="label",name="VSPipe",label="VSPipe.exe:",hint="Encode use CPU"},
	{x=7,y=2,width=3,class="edit",name="VSPipepath",value=VSPipepath or ""},
	{x=0,y=3,class="label",name="Nvidia",label="NVEncC64.exe:"},
	{x=1,y=3,width=5,class="edit",name="nvencpath",value=nvencpath or ""},
	{x=6,y=3,class="label",name="Intel",label="QSVEncC64.exe:"},
	{x=7,y=3,width=3,class="edit",name="qsvencpath",value=qsvencpath or ""},
	{x=0,y=4,class="label",name="AMD",label="VCEEncC64.exe:"},
	{x=1,y=4,width=5,class="edit",name="vceencpath",value=vceencpath or ""},
